...
def main():
    ...
    window_size = 1024  # Define the window size as needed
    sequence_lengths = [2, 3,  4, 8]  # Lengths of sequences to check
    ...
    for length in sequence_lengths:
        ...
        print(f"Average number of adjacent sequences of length {length} per window of size {window_size}: {average_count:.2f}")
