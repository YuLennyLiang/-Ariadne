...
for pfn in lru_pfn_numbers:
    if pfn in swapout_ttid_pfn_numbers_matched:
        total_hot_ttid_page += 1
...
coverage = hot_ttid_page / total_hot_ttid_page
accuracy = (hot_ttid_page + hot_ttfd_page + warm_page + not_swapout_page) / window_size
print(f"BangDream coverage: {coverage} accuracy: {accuracy}")