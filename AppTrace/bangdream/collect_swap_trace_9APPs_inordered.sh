...
adb shell "echo 10129 > /sys/kernel/swap_tracing_on/app_id"
adb shell "echo 10129 > /sys/kernel/lru_active_anon/app_id"
...
echo "2"
start_activity com.bilibili.star.bili/.PermissionActivity
sleep 3
sleep $test_run_time
enter_home
